  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• „Neuer Ordner“ legt einen leeren Ordner im Archiv an',
        '• ✎ an einer Zeile benennt den Eintrag um; der komplette Pfad ist editierbar, so lassen sich Dateien auch verschieben — Ordner nehmen ihren Inhalt mit',
        '• Auswahl + „Löschen“ entfernt Einträge; ausgeführt wird erst beim zweiten Klick („Wirklich löschen?“)',
        ...
        'Unveränderte Einträge werden 1:1 übernommen (nicht neu komprimiert). Bei verschlüsselten ZIPs braucht das Bearbeiten das Passwort — Einträge werden damit neu verschlüsselt (AES-256), neue Dateien ebenfalls.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• “New folder” creates an empty folder inside the archive',
        '• ✎ on a row renames the entry; the full path is editable, so files can also be moved — folders take their contents along',
        '• Selection + “Delete” removes entries; it only executes on the second click (“Really delete?”)',
        ...
        'Unchanged entries are copied 1:1 (not recompressed). Encrypted ZIPs need the password for editing — entries are re-encrypted with it (AES-256), new files too.',
