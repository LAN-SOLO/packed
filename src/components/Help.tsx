...
const de: Content = {
  ...
  tutorial: [
    ...
    },
    {
      ...
      body: [
        ...
        'Geöffnete ZIPs lassen sich außerdem direkt bearbeiten: Dateien und Ordner hinzufügen, Einträge umbenennen oder löschen — Details im Handbuch unter „ZIP bearbeiten“.',
      ],
  ...
  sections: [
    ...
    {
      id: 'edit',
      title: 'ZIP bearbeiten',
      body: [
        'Geöffnete ZIP-Archive lassen sich direkt bearbeiten — ohne Entpacken und neu Packen:',
        '• „Dateien hinzufügen …“ / „Ordner hinzufügen …“ oben rechts — oder Dateien einfach ins Fenster ziehen',
        '• „Neuer Ordner“ legt einen leeren Ordner im Archiv an — Enter bestätigt den Namen, Esc bricht ab',
        '• ✎ an einer Zeile benennt den Eintrag um; der komplette Pfad ist editierbar, so lassen sich Dateien auch verschieben — Ordner nehmen ihren Inhalt mit. Enter übernimmt, Esc verwirft',
        '• Auswahl + „Löschen“ entfernt Einträge; ausgeführt wird erst beim zweiten Klick („Wirklich löschen?“). Nach 4 Sekunden ohne Bestätigung entschärft sich der Knopf von selbst — eine geänderte Auswahl ebenfalls',
        'packed schreibt das Archiv dabei sicher neu: erst vollständig in eine temporäre Datei, die das Original dann in einem Schritt ersetzt — ein Abbruch hinterlässt nie ein halbes Archiv.',
        'Unveränderte Einträge werden 1:1 übernommen (nicht neu komprimiert). Bei verschlüsselten ZIPs braucht das Bearbeiten das Passwort — das vorhandene Passwort wird weiterverwendet und schützt auch neu hinzugefügte Dateien (AES-256); ein anderes Passwort lässt sich beim Bearbeiten nicht vergeben.',
        'TAR- und tar.*-Archive sind vorerst schreibgeschützt — Bearbeiten gibt es zunächst für ZIP.',
      ],
      action: { label: 'Archiv öffnen …', cmd: 'open' },
    },
    {
      ...
      body: [
        ...
        'Nach dem Erstellen zeigt packed das Ergebnis mit Größe und Ersparnis („spart X %“ gegenüber der Originalgröße) — „Im Finder zeigen“ öffnet das fertige Archiv im Dateimanager. Auch die Archiv-Ansicht trägt ein −X-%-Badge, wenn das Archiv kleiner ist als sein Inhalt.',
      ],
    ...
    },
    {
      ...
      body: [
        'F1 oder ⌘ + / (Windows/Linux: Strg + /) öffnet diese Hilfe kontextsensitiv: Das Handbuch springt direkt zum Abschnitt der aktuellen Ansicht — Öffnen, Entpacken oder Erstellen.',
        'Esc schließt die Hilfe und bricht Umbenennen bzw. „Neuer Ordner“ ab; Enter bestätigt den eingegebenen Namen.',
        'Im Tutorial blättern die Pfeiltasten ← und → durch die Schritte.',
      ],
    },
    {
      id: 'updates',
    ...
    },
    {
      ...
      body: [
        ...
        '• Bearbeiten auch für TAR- und tar.*-Archive',
...
const en: Content = {
  ...
  tutorial: [
    ...
    },
    {
      ...
      body: [
        ...
        'Opened ZIPs can also be edited directly: add files and folders, rename or delete entries — details in the manual under “Editing ZIPs”.',
      ],
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'Editing ZIPs',
      body: [
        'Opened ZIP archives can be edited directly — no extracting and repacking:',
        '• “Add files …” / “Add folder …” in the top right — or simply drop files onto the window',
        '• “New folder” creates an empty folder inside the archive — Enter confirms the name, Esc cancels',
        '• ✎ on a row renames the entry; the full path is editable, so files can also be moved — folders take their contents along. Enter applies, Esc discards',
        '• Selection + “Delete” removes entries; it only executes on the second click (“Really delete?”). Without confirmation the button disarms itself after 4 seconds — changing the selection disarms it too',
        'packed rewrites the archive safely: first completely into a temporary file, which then replaces the original in one step — an interruption never leaves a half-written archive.',
        'Unchanged entries are copied 1:1 (not recompressed). Encrypted ZIPs need the password for editing — the existing password is kept and also protects newly added files (AES-256); a different password cannot be set while editing.',
        'TAR and tar.* archives are read-only for now — editing starts with ZIP.',
      ],
      action: { label: 'Open an archive …', cmd: 'open' },
    },
    {
      ...
      body: [
        ...
        'After creation, packed shows the result with size and savings (“saves X%” compared to the original size) — “Reveal in Finder” opens the finished archive in the file manager. The archive view also carries a −X% badge whenever the archive is smaller than its contents.',
      ],
    ...
    },
    {
      ...
      body: [
        'F1 or ⌘ + / (Windows/Linux: Ctrl + /) opens this help contextually: the manual jumps straight to the section matching the current view — opening, extracting or creating.',
        'Esc closes the help and cancels renaming or “New folder”; Enter confirms the entered name.',
        'In the tutorial, the ← and → arrow keys page through the steps.',
      ],
    },
    {
      id: 'updates',
    ...
    },
    {
      ...
      body: [
        ...
        '• Editing for TAR and tar.* archives too',
