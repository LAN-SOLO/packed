...
const de = {
  ...
  extractSelected: (n: number) => `Auswahl entpacken (${n}) …`,
  selectAllTitle: 'Alle aus-/abwählen',
  clearSelection: 'Auswahl aufheben',
  selectHint: '// Klick wählt aus · Doppelklick entpackt die Datei direkt',
  selectHintEdit:
    '// Klick wählt aus · Doppelklick entpackt · ✎ benennt um (kompletter Pfad editierbar)',
  // edit (ZIP)
  newFolder: 'Neuer Ordner',
  newFolderPlaceholder: 'Ordnername — Enter legt an',
  renameEntry: 'Umbenennen',
  deleteSelected: (n: number) => `Löschen (${n})`,
  reallyDelete: 'Wirklich löschen?',
  editedAdded: (n: number) => `${n} Einträge zum Archiv hinzugefügt`,
  editedFolder: (name: string) => `Ordner „${name}“ angelegt`,
  editedRenamed: (name: string) => `Umbenannt in „${name}“`,
  editedDeleted: (n: number) => `${n} Einträge entfernt`,
  editError: 'Bearbeiten fehlgeschlagen',
  editNeedsPassword:
    'Verschlüsseltes Archiv: zum Bearbeiten zuerst das Passwort unten eintragen.',
  extracting: 'Entpacke …',
...
const en: typeof de = {
  ...
  extractSelected: (n: number) => `Extract selection (${n}) …`,
  selectAllTitle: 'Select/deselect all',
  clearSelection: 'Clear selection',
  selectHint: '// click selects · double-click extracts the file right away',
  selectHintEdit: '// click selects · double-click extracts · ✎ renames (full path editable)',
  newFolder: 'New folder',
  newFolderPlaceholder: 'Folder name — Enter creates it',
  renameEntry: 'Rename',
  deleteSelected: (n: number) => `Delete (${n})`,
  reallyDelete: 'Really delete?',
  editedAdded: (n: number) => `${n} entries added to the archive`,
  editedFolder: (name: string) => `Folder “${name}” created`,
  editedRenamed: (name: string) => `Renamed to “${name}”`,
  editedDeleted: (n: number) => `${n} entries removed`,
  editError: 'Editing failed',
  editNeedsPassword: 'Encrypted archive: enter the password below before editing.',
